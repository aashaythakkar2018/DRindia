...
import { Shield, BookOpen, Heart, Activity, AlertCircle, FileText, HelpCircle, ArrowRight, CheckCircle2 } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="w-full bg-white">
      ...
      <section className="relative min-h-[700px] flex items-center pt-20 bg-[#1A3E5F] overflow-hidden text-center text-white">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-4xl mx-auto flex flex-col items-center">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight mb-4 tracking-wide">
            ...
            <Link
              to="/services"
              className="bg-[#C1440E] hover:bg-[#C1440E]/90 text-white rounded-button px-8 py-4 font-medium transition-all hover:-translate-y-1 shadow-lg shadow-[#C1440E]/20 flex items-center group"
            >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="bg-white p-8 rounded shadow-lg text-center transform hover:-translate-y-2 transition-all duration-300">
      ...
      <section className="py-20 bg-gray-900 text-white relative overflow-hidden flex flex-col items-center">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-sm font-bold text-[#C1440E] uppercase tracking-wider mb-2">Our Commitment</h2>
            <h3 className="text-3xl md:text-4xl font-black mb-4">Code of Conduct</h3>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 items-center">
            {["ATUL LTD", "AKZONOBEL INTERNATIONAL", "ASIAN PAINTS", "HTD NextGen", "PPG-SIGMA", "BERGER PAINTS", "HEMPEL PAINTS", "JOTUN", "KIRLOSKAR CORROCOAT"].map((brand, idx) => (
              <div key={idx} className="bg-gray-50 hover:bg-gray-100 transition-all p-6 rounded-xl border border-gray-100 flex items-center justify-center h-28 w-full shadow-sm hover:shadow-md">
